...
import { Languages, User, Users, Search } from "lucide-react";
      ...
      <div className="flex flex-col gap-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground">
            Browse interactive Mandarin lessons designed to improve speaking,
            listening, reading, and pronunciation skills.
          </p>
        </div>
