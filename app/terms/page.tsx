        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <p className="text-muted-foreground leading-relaxed">
              Welcome to Mandarin Academy. These Terms of Service (&quot;Terms&quot;) govern your use of our website, 
              mobile application, and services (collectively, the &quot;Service&quot;) operated by Mandarin Academy 
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                software, is owned by Mandarin Academy or our content providers and is protected by 
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-sm space-y-1">
              <p><strong>Email:</strong> Mandarin@learngmail.com</p>
              <p><strong>Address:</strong> Mandarin learn center</p>
              <p><strong>Phone:</strong> +62 1234567</p>
            </div>
          </CardContent>
        </Card>
      </div>
