...
export default function ProfilePage() {
  ...
  const totalLessons = (enrollments || []).reduce(
    (acc, e) => acc + (e.course.lessons?.length || 0),
    0,
  );
  ...
  const memberSince = new Date(
    session.user.email ? "2024-01-01" : Date.now(),
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen overflow-hidden bg-background/80 backdrop-blur-sm">
        <MainNav />
