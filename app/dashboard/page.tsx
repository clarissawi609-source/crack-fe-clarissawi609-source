        ...
        <main className='flex-1 flex items-center justify-center py-12'>
          <div className='container mx-auto px-4 py-8 max-w-7xl'>
            <div className='animate-pulse'>
              ...
              {/* Header Skeleton */}
              <div className='mb-8'>
                <div className='h-10 w-80 rounded-xl bg-white/40 backdrop-blur-md mb-4'></div>
                <div className='h-5 w-96 rounded-xl bg-white/30 backdrop-blur-md'></div>
              </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className='h-36 rounded-2xl border border-white/20 bg-white/30 backdrop-blur-xl shadow-xl'
                  ></div>
                ))}
              </div>

              {/* Tabs Skeleton */}
              <div className='rounded-2xl border border-white/20 bg-white/20 backdrop-blur-xl p-6 shadow-xl'>
                <div className='h-12 w-full rounded-xl bg-white/30 mb-6'></div>

                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  {[1, 2].map((i) => (
                    <div
                      key={i}
                      className='h-[280px] rounded-2xl border border-white/20 bg-white/30 backdrop-blur-md shadow-lg'
                    ></div>
                  ))}
                </div>
              </div>
